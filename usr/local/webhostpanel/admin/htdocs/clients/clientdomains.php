...
?>
    <center>
      ...
      <tr align="center"> 
        <td colspan="8"> <a href="../clients/clients.php"><img src="../Icons/btn_backup_bg.gif" border="0" alt="Back"></a> 
        </td>
      </tr>
    </center>
...
?>
    <tr align="left"> 
      <td colspan="10" bgcolor="#FFFFFF"  class="navigation"><img src="../Icons/btn_domain-user_bg.gif" width="24" height="22">&nbsp;&nbsp;Domain 
    ...
    <tr align="center"> 
      ...
      <td width="39%" align="left" bgcolor="#FFE2C6" class="tableheadings">Domain 
        Name</td>
      <td width="10%" bgcolor="#CAE1EC" class="tableheadings">View Site</td>
      <td width="12%" align="center" bgcolor="#CFECF1" class="tableheadings">Creation 
        Date</td>
      <td width="10%" align="center" bgcolor="#CFECF1" class="tableheadings">Traffic</td>
      <td colspan="2" bgcolor="#CFECF1" class="tableheadings">Disk Usage</td>
      <td width="5%" bgcolor="#CFECF1" class="tableheadings"><a href="javascript:invertChecked()" style="text-decoration:none">Sel</a> </font></strong> 
      </td>
    </tr>
    <?
...
?>
    <tr align="center" bgcolor="<?=$bgcol?>" onmouseover="bgColor='#DDDDDD'" onmouseout="bgColor='<?=$bgcol?>'"> 
      ...
      <td align="left" class="clientheading"><a href="setdomainid.php?domainid=<?=$domains->domainid?>" style="text-decoration:none"><font size="1"> 
        <?=$domains->domainname?>
        </font></a></td>
...
<?
	$query = "Select traffic from monthly_traffic where domainname ='$domains->domainname'";
	//Echo $query;
...
?>
      <td align="center" class="clientheading"><?=$DomainTraffic?></td>
    ...
    <tr align="center"> 
      <?
		if(strtoupper($_SESSION["type"])=="A")
			{
?>
      <td colspan="10"  class="clientheading"> <a href="clientdomains.php"><img src="../Icons/btn_backup_bg.gif" border="0" alt="Back">Back</a></td>
      <?
			}
		elseif(strtoupper($_SESSION["type"])=="C")
			{
?>
      <td width="6%" colspan="7"> <a href="../domains/clientdomains.php"><img src="../Icons/btn_backup_bg.gif" border="0" alt="Back">Back</a></td>
      <?
			}
?>
    </tr>
