...
?>
    <tr> 
      <td align="left" ><strong><font color="#000000" face="Verdana">Administrator 
        ...
        <?=$_SESSION["clientname"]?>
        &gt;</font></font><font color="#000000" face="Verdana"> Edit Contact Information</font></strong></td>
    </tr>
    <?
		}
...
?>
  ...
  <table border="0" cellpadding=0 cellspacing=0 width="564" align="center">
    ...
    <tr> 
      <td><font color="#FF0000">Enter new client data:</font></td>
      <td></td>
      <td class="verttop"><input name="button" type="button" class="commonButton" id="bid-up-level" title="Up Level"  onClick="window.location='/clients/clients.asp';" value="Up Level"  ></td>
    </tr>
    <tr> 
    ...
    <tr> 
	  ...
	  <table border="0" cellpadding=0 cellspacing=0 width="558" align="left">
          ...
          <tr> 
            <td align='right'>Control Panel login name:</td>
            <td align='center'><font color="#FF0000"><span class="requiredfield">*</span></font></td>
            <td><input type='text' name='login' size=25 maxlength=20 value=""></td>
          </tr>
          <tr> 
            <td colspan=1><img src="/skins/<?=$_SESSION["skin"]?>/elements/white.gif" alt="" width="1" height="8" border="0"></td>
          </tr>
          <tr> 
            <td align='right'>Control Panel Password:</td>
            <td align='center'><font color="#FF0000"><span class="requiredfield">*</span></font></td>
            <td><input type='password' name='passwd0' size=25 maxlength=14 value=""></td>
          </tr>
          <tr> 
            <td colspan=1><img src="/skins/<?=$_SESSION["skin"]?>/elements/white.gif" alt="" width="1" height="8" border="0"></td>
          </tr>
          <tr> 
            ...
            <td><input type='password' name='passwd1' size=25 maxlength=14 value=""></td>
          </tr>
          <tr> 
            <td colspan=1><img src="/skins/<?=$_SESSION["skin"]?>/elements/white.gif" alt="" width="1" height="8" border="0"></td>
          </tr>
...
?>
    ...
    <tr> 
      ...
      <td colspan=2 align="right"> <input type="button" class="commonButton" id="bid-update" value="Create" title="Update"  onClick="return chk_form_data(document.mainform);" > 
      </td>
    </tr>
    <tr> 
      <td colspan=1><img src="/skins/<?=$_SESSION["skin"]?>/elements/white.gif" alt="" width="1" height="8" border="0"></td>
