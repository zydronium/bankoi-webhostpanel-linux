  ...
  <tr>
    <td height="67"><form name="form1" action="modifyDnsEntry.php?mode=add" method="post">
        ...
        <table width="100%" border="0">
          ...
          <tr> 
            <td colspan="4"><font color="#FF0000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><img src="/skins/default/elements/line.gif" width=600 height=1 border=0></strong></font></td>
          </tr>
        </table>
        </form>
...
<table width="62%" align="center">
  <tr>
    <td><form name="form2" action="" method="post">
        <p align="right"><br>
...
<?
		...
		$query="select * from tbldnstemplate where resellerid='$resellerid' order by recordtype";
...
<p align="center"><font color="#FF0000" size="2" face="Verdana, Arial, Helvetica, sans-serif"><strong><img src="/skins/default/elements/line.gif" width=600 height=1 border=0></strong></font></p>
<p align="center"> 
  <input type="button" name="Button352" value="Back" class="commonButton" onClick="window.location='/domains/clientdomains.php'">
</p>
</body>
</html>
<br>
