 ...
 */
/*$cfg['PmaAbsoluteUri'] = 'http://209.189.236.161:8443/phpMyAdmin/';
*/
$cfg['PmaAbsoluteUri'] = 'https://192.168.0.1:8443/phpMyAdmin/';
...
$i++;
$cfg['Servers'][$i]['host']          = 'localhost'; // '209.189.236.161'; // MySQL hostname or IP address
